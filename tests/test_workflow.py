...
class WorkflowTests(unittest.TestCase):
    def test_run_watchlist_workflow_writes_outputs_and_uses_valuation_csv(self):
        ...
        self.assertEqual(summary["artifact_registry"]["self"], str(summary_path))
        self.assertEqual(summary["artifact_registry"]["dependencies"]["watchlist"], str(watchlist))
        self.assertEqual(summary["artifact_registry"]["outputs"]["dashboard"], str(output_dir / "dashboard.html"))
